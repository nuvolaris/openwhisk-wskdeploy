...
var (
	manifestPath   = os.Getenv("GOPATH") + "/src/github.com/nuvolaris/openwhisk-wskdeploy/tests/src/integration/message-hub/manifest.yaml"
	deploymentPath = os.Getenv("GOPATH") + "/src/github.com/nuvolaris/openwhisk-wskdeploy/tests/src/integration/message-hub/deployment.yaml"
)
