...
var (
	manifestPath   = os.Getenv("GOPATH") + "/src/github.com/nuvolaris/openwhisk-wskdeploy/tests/src/integration/alarmtrigger/manifest.yaml"
	deploymentPath = os.Getenv("GOPATH") + "/src/github.com/nuvolaris/openwhisk-wskdeploy/tests/src/integration/alarmtrigger/deployment.yaml"
)
